...
func BuildDocument(query qb.Query, transport Transport, opts ...Option) (OrderedObject, error) {
...
func encodeProjections(values []qb.Projection, transport Transport, config options) (any, error) {
	if config.mode == Compact && projectionsAreSimple(values) {
...
func encodeProjection(value qb.Projection, transport Transport, config options) (any, error) {
...
func encodeGroups(values []qb.Scalar, transport Transport, config options) (any, error) {
	if config.mode == Compact && scalarsAreSimpleFields(values) {
		fields := make([]string, len(values))
...
func encodeSorts(values []qb.Sort, transport Transport, config options) (any, error) {
	if config.mode == Compact && sortsAreSimple(values) {
...
func encodeWhere(expr qb.Expr, transport Transport, config options) (OrderedObject, error) {
...
func encodeWhereRaw(expr qb.Expr, transport Transport, config options) (map[string]any, error) {
...
func encodeAndWhere(terms []qb.Expr, transport Transport, config options) (map[string]any, error) {
...
func encodePredicateWhere(predicate qb.Predicate, transport Transport, config options) (map[string]any, error) {
...
func encodeFieldPredicate(predicate qb.Predicate, transport Transport, config options) (string, any, bool, error) {
...
func encodeExpressionPredicate(predicate qb.Predicate, transport Transport, config options) (map[string]any, error) {
...
func encodeFilterKey(expr qb.Scalar, config options) (string, bool, error) {
...
func encodeScalar(expr qb.Scalar, transport Transport, config options, ctx dsl.Context) (any, error) {
