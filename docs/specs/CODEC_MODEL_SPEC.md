...
This spec assumes a hard refactor from `parser/*` to `codecs/*` with no concern
...
Whether `codecs/internal/dsl` is public or internal is out of scope for this spec. The
