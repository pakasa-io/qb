...
func ParseDocument(input map[string]any, opts ...codecconfig.Option) (qb.Query, error) {
...
func Parse(input map[string]any, opts ...codecconfig.Option) (qb.Query, error) {
...
func parseSelect(node any, opts codecconfig.Config, path string) ([]qb.Projection, error) {
...
func parseGroup(node any, opts codecconfig.Config, path string) ([]qb.Scalar, error) {
	switch typed := node.(type) {
	case string:
		fields, err := parseSimpleFieldList(typed, path)
		if err != nil {
...
func parseSorts(node any, opts codecconfig.Config, path string) ([]qb.Sort, error) {
	switch typed := node.(type) {
	case string:
...
func parseWhere(node map[string]any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parseLogicalGroup(combine func(...qb.Expr) qb.Expr, node any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parseComputedFilter(key string, node any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parsePredicate(left qb.Scalar, op qb.Operator, node any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parseExpressionPredicates(node any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parseExpressionPredicate(op qb.Operator, node any, opts codecconfig.Config, path string) (qb.Expr, error) {
...
func parseMixedScalar(node any, field string, op qb.Operator, opts codecconfig.Config, path string) (qb.Scalar, error) {
...
func resolveFilterScalar(expr qb.Scalar, op qb.Operator, opts codecconfig.Config, path string) (qb.Scalar, error) {
...
func resolveGroupScalar(expr qb.Scalar, opts codecconfig.Config, path string) (qb.Scalar, error) {
...
func resolveGroupScalars(values []qb.Scalar, opts codecconfig.Config, path string) ([]qb.Scalar, error) {
	if len(values) == 0 {
		return nil, nil
	}
...
func resolveSortScalar(expr qb.Scalar, opts codecconfig.Config, path string) (qb.Scalar, error) {
...
func resolveSortScalars(values []qb.Scalar, opts codecconfig.Config, path string) ([]qb.Scalar, error) {
	if len(values) == 0 {
		return nil, nil
	}
	out := make([]qb.Scalar, len(values))
...
func parseCursor(node any, opts codecconfig.Config, path string) (*qb.Cursor, error) {
	switch typed := node.(type) {
	case string:
...
func decodeValue(field string, op qb.Operator, value any, opts codecconfig.Config, path string) (any, error) {
...
func parseProjectionNode(node map[string]any, opts codecconfig.Config, path string) (qb.Projection, error) {
...
func parseSortNode(node map[string]any, opts codecconfig.Config, path string) (qb.Sort, error) {
...
func parseScalarAny(node any, opts codecconfig.Config, path string) (qb.Scalar, error) {
...
func parseScalarNode(node map[string]any, opts codecconfig.Config, path string) (qb.Scalar, error) {
	switch {
...
func parseLiteralNode(node map[string]any, opts codecconfig.Config, path string) (any, error) {
	raw, ok := node["$literal"]
	if !ok {
...
func parseCursorValue(value any, opts codecconfig.Config, path string) (any, error) {
	if node, ok := value.(map[string]any); ok && looksLikeLiteralNode(node) {
...
func literalTokenDecoder(codec codecconfig.LiteralCodec) dsl.LiteralTokenDecoder {
